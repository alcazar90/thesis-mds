...
%The reward is how we encoded our progression to the goal. Therefore, the reinforcement learning is a framework to learn to act, 
...
%The main difference between supervised learning and reinforcement learning
%is that we don't have an explicit feedback of each action in form a 
