...
\begin{enumerate}
    ...
    \item Reversing $q(\mathrm{x}_{t}\mid\mathrm{x}_{t-1})$ by $q(\mathrm{x}_{t-1}\mid\mathrm{x}_{t}, \mathrm{x}_{0})$ (bayes theorem) in step \ca{completar...}. 
...
\ca{\textbf{Completar:} breve introducir classifier guidance cmo principal alternativa de control. Describir experimento con CLIP guidance. \textbf{Importante:} presentar classifier free guidance no comoo competidor, sino como complemento a entrnar grandes mdelos condicines generales cmo SB o Imagen oo Dalle que se complementan con ajustes con reinforcemeent learning.} \\
