...
\ca{El outline y contribuciones de la tesis ya estan claras. La estructura de la tesis no va a cambiar, y si bien la extensión del framework DDPO no se encuentra lista, esta claro lo qué se va a hacer: agregar baseline e incorporar retorno de los steps intermedios a la universal guidance.}

In this thesis we will explore the use of Reinforcement Learning techniques to adapt pre-trained diffusion models to new tasks. Specifically, we develop... The main contributions of this work are:
