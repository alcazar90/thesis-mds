...
\def\nameagradec {Acknowledgments}    % Nombre del cap. de agradecimientos
...
\def\nameltappendixsection {}    % Etiqueta sección en anexo/apéndices
% \def\nameltcont{Contents}   % Nombre del índice de contenidos
\def\nameltcont{Content}   % Nombre del índice de contenidos
\def\namelteqn {Índice de Ecuaciones} % Nombre de la lista de ecuaciones
\def\nameltfigure{List of Figures} % Nombre de la lista de figuras
\def\nameltsrc {List of Codes}    % Nombre de la lista de código
\def\namelttable {List of Tables}   % Nombre de la lista de tablas
\def\nameltwfigure {Figure}           % Etiqueta leyenda de las figuras
\def\nameltwsrc {Code}              % Etiqueta leyenda del código fuente
\def\nameltwtable {Table}             % Etiqueta leyenda de las tablas
...
\def\namereferences {Bibliography}    % Nombre de la sección de referencias