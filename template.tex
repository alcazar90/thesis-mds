...
\usepackage{changepage}	   % Permite cambiar los margenes de la página, caption
\usepackage{algorithm}	   % Permite escribir algoritmos
\usepackage{algorithmic}   % Permite escribir algoritmos
%\usepackage{subcaption}	   % Permite multiples caption en una figura (util con minipage)
% -----------------------------------------------------------------------------
...
% Comando para agregar una cita al principio de un chapter
\makeatletter
...
% código para abstract en español
\newenvironment{abstractdesp}{%
	\ifthenelse{\isundefined{\abstracttable}}{%
		\def\abstracttable {}}{%
	}%
	\begin{abstractenv}{\abstracttableesp}{\documenttitleesp}{\nameabstract}{abstractbookmark}%
	}{%
	\end{abstractenv}%
}